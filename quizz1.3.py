...
class RootWidget(FloatLayout):
    ...
    def button_pressed(self, button):
        ...
        popup_gagne = Popup(title='Gagné ! Distribue 2 gorgées', content=bouton_continuer, size_hint=(.6, .6), pos_hint = {'center_x': .5, 'center_y': .4},auto_dismiss = True)
        bouton_continuer.bind(on_press=lambda *args: Popup.dismiss(popup_gagne))
